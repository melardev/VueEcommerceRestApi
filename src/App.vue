<template>
    <div>
        <app-header :shouldShowCartDialog="shouldShowCartDialog" @toggle-popup-cart="togglePopupCart"></app-header>
...
<script>
    ...
    export default {
        ...
        methods: {
            togglePopupCart() {
                this.shouldShowCartDialog = !this.shouldShowCartDialog;
            }
        },
        computed: {
            hastProductsInCart() {
